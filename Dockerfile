...
CMD touch /rtorrent/.session/rtorrent.lock && rm /rtorrent/.session/rtorrent.lock && cd flood && screen -S rtorrent -dm rtorrent && sleep 3  && screen -S flood -dm npm start && tail -f /dev/null
